@echo off
set "Then Say=call :SpeakAnswer"
set person=Sam
set MyName=Siri
set sex=Female
set SexWord=Sam
:: Speech Variables
set noSwear=Don't swear %person%, I know where you live!
:ask
set /p Question="Ask A Question? "
set "If The Question Is=if /i "%question%" =="
%If The Question Is% "hello" %Then Say% "hello %person%"
%If The Question Is% "hello %myname%" %Then Say% "hello %person%"
%If The Question Is% "hi" %Then Say% "hello %person%"
%If The Question Is% "hi %myname%" %Then Say% "hello %person%"
%If The Question Is% "Who Are you" %Then Say% "I am %myname%"
%If The Question Is% "Who're you" %Then Say% "I'm %myname%"
%If The Question Is% "Are you a boy or girl" %Then Say% "I'm a %sex%"
%If The Question Is% "shit" %Then Say% "%noSwear%"
%If The Question Is% "fuck" %Then Say% "%noSwear%"
%If The Question Is% "piss" %Then Say% "%noSwear%"
%If The Question Is% "cock" %Then Say% "%noSwear%"
%If The Question Is% "cunt" %Then Say% "%noSwear%"
%If The Question Is% "sugar" %Then Say% "%noSwear%"
%If The Question Is% "where do you live" %Then Say% "I live with you %sexWord%!"
%If The Question Is% "kiss me" %Then Say% "No can do. Sorry to say"
%If The Question Is% "good day" %Then Say% "Good day to you!"
%If The Question Is% "will you go out with me" %Then Say% "No, sorry mate"
%If The Question Is% "what is the time" call :setTime&%Then Say% "%twelve%"
