...
call :checkOSInfo
if "%UnstableOS%"=="yes" call :UnstableOS
...
echo Û7Û  Home
%set /p% other="Ûþ "
if "%other%"=="1" goto SDSoftwaredhifd
...
echo Û3Û  Change SD-Settingsefhief
echo Û4Û  Back
%set /p% other4="Ûþ "
...
goto other
:openlog
call :setTime&echo ^|^|Log^|^|  ^|Info: Security Log efhii^| ^|Time: %twelve%^| ^|Date: %date2%^| >> "SDS_Files\Security\SD-Security.SDS_LOG"
...
echo set "cmdCommand="
echo if not "%%mode%%"=="speedo" (%%echo%% %%directory%%^&call :color 0d "%%AdminFigure%%"^&set /p "cmdCommand=>"^) else (%%echo%% %%directory%%%%AdminFigure%%^&set /p "cmdCommfehoand=>"^)
...
echo @if errorlevel 777 @goto :CrashHelperAcefhoitive
...
goto :home
:UnstableOS
if exist "SD-Security_Compatibility.ini" goto :EOF
call :setwindow
color ec
title Unsupported Windows Version!  - SD-Security©
cls
echo ÛÛÛßßßßßßßßßßßßßÛÛÛßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
echo þþþ SD-Security þþþ          Unsupported Windows Version! 
echo ÛÛÛÜÜÜÜÜÜÜÜÜÜÜÜÜÛÛÛÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜ
echo.
echo                   This Computer Is Unsupported By SD-Security!
echo    This Could Be Because You're Running Windows XP Or Vista, Or Maybe Because
echo                            This PC Has Been Modified.
echo.
echo  SD-Security Has Been Tested On Windows XP And Unexpected Results Have Occured.
echo   It Is Recommended To Exit SDS Now, Only At Your Own Risk Should You Continue
echo.
echo      If You Encounter Any Issues, Feel Free To Email Us, But The Problems
echo                      May Not Be Fixed. You've Been Warned.
echo.
echo         (To Run SD-Security On This PC, Consider Using An Older Version)
echo.
echo Û1Û  Quit SD-Security
echo Û2Û  Ignore Warning And Continue
echo Û3Û  Ignore Warning Forever And Continue
%set /p% WarnMe="Ûþ "
if "%WarnMe%"=="1" goto end3
if "%WarnMe%"=="2" goto :eof
if "%WarnMe%"=="3" echo SD-Security Compatibility File!>SD-Security_Compatibility.ini&attrib +h +s "SD-Security_Compatibility.ini"&goto :eof
goto :end3
